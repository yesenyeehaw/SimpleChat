...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MessageViewHolder> {
    ...
    //tells us if the message is sent by me
    private boolean isMe(int position) {
        Message message = mMessages.get(position);
        return message.getUserId() != null && message.getUserId().equals(mUserId);
    }

    //tells us if message is outgoing or incoming
    @Override
    ...
    //responsible for decoding user ID and creating an image URL that can be passed into the Glide library
